...
public class AIBoard extends Board{
  ...
  /**
   * Called to make the AI oponent make a move based on the difficulty
   * selected.
   * @return True if the current player has won, False otherwise
   */
  ...
  /**
   * For now, the heuristic value is the difference between the scores of the players, favoring black.
   *
   * Other ideas:
