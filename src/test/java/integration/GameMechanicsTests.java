...
public class GameMechanicsTests {
    ...
    public void testNoScoringOnOdd(){
        ...
        swinger.clickOn("name:New Game", Speed.MAX_VALUE).pause(250).clickOn("name:Two Player", Speed.MAX_VALUE).pause(250);

        ScoreGUILabel whiteScoreLabel = (ScoreGUILabel)swinger.getAt("name:whiteScore");
        ScoreGUILabel blackScoreLabel = (ScoreGUILabel)swinger.getAt("name:blackScore");

        swinger.clickOn("name:Hole3", Speed.MAX_VALUE).pause(250).clickOn("name:Hole-7", Speed.MAX_VALUE).pause(250);
    ...
    public void testWhiteScoreInTuz(){
        swinger.clickOn("name:New Game", Speed.MAX_VALUE).pause(250).clickOn("name:Two Player", Speed.MAX_VALUE)
        .pause(250).clickOn("name:Hole3", Speed.MAX_VALUE).pause(250).clickOn("name:Hole-7", Speed.MAX_VALUE).
        pause(250).clickOn("name:Hole9", Speed.MAX_VALUE).pause(250).clickOn("name:Hole-8", Speed.MAX_VALUE).pause(250);
    ...
    public void testBlackScoreInTuz(){
        swinger.clickOn("name:New Game", Speed.MAX_VALUE).pause(250).clickOn("name:Two Player", Speed.MAX_VALUE).pause(250)
        .clickOn("name:Hole3", Speed.MAX_VALUE).pause(250).clickOn("name:Hole-7", Speed.MAX_VALUE).pause(250)
        .clickOn("name:Hole4", Speed.MAX_VALUE).pause(250);
    ...
    public void testKorgoolsMoveCorrectly(){
        ...
        // White turn 1
        swinger.clickOn("name:New Game", Speed.MAX_VALUE).pause(500).clickOn("name:Two Player", Speed.MAX_VALUE).pause(250).clickOn("name:Hole3", Speed.MAX_VALUE).pause(500);
